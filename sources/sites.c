 ...
 *
  ...
  * Modified by Omicia Inc. to increase caclulation speed
 */


// modified by Omicia: deleted unused includings
...

{
    ...
    static int Tables_Loaded[300] = {FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,
